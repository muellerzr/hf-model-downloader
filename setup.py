...
setup(
    ...
    version="0.0.1",
    description="HuggingFace model downloader",
    ...
    url="https://github.com/muellerzr/hf-downloader",
    package_dir={"": "src"},
    packages=find_packages("src"),
    entry_points={
        "console_scripts": [
            "download-model=hf_downloader.cli:main",
        ],
    },
...
#      pip uninstall hf-downloader
#      pip install -i https://testpypi.python.org/pypi hf-downloader
